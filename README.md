...
이 프로젝트는 **플래피 어드벤처**의 Flutter 구현체입니다.
...
| 문서 | 설명 |
|------|------|
| [docs/design/gdd_game_0008.json](docs/design/gdd_game_0008.json) | 게임 디자인 문서 |
...
**HUD 파일**: [game/lib/ui/hud/mg_flappy_hud.dart](game/lib/ui/hud/mg_flappy_hud.dart)
