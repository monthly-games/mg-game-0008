...
Flappy bird style arcade game

<!-- MG-GAME-SHOWCASE:START -->
## Gameplay Showcase

![Time Loop Village Defense gameplay screen](docs/images/gameplay-showcase.png)

**Time Loop Village Defense** centers on the **Build and Survive** loop. The player enters from the main menu, reads the active objective and pressure state, performs the core action, banks rewards, then returns through roadmap and retention goals.
...
git clone --recursive https://github.com/monthly-games/mg-game-0008.git
