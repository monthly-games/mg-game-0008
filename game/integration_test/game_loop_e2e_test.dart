...
void main() {
  ...
  group('MG-0008 Flappy Adventure - Game Loop E2E', () {
    testWidgets('Core gameplay loop: flapping mechanics and adventure', (tester) async {
      await tester.pumpWidget(const MyApp());
      await tester.pumpAndSettle();

      expect(find.byKey(const ValueKey('game-id')), findsOneWidget);
      expect(find.text('MG-0008'), findsOneWidget);
    ...
    testWidgets('Daily challenge system', (tester) async {
      await tester.pumpWidget(const MyApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('Boss raid system', (tester) async {
      await tester.pumpWidget(const MyApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('Adventure progression and world exploration', (tester) async {
      await tester.pumpWidget(const MyApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('Full game loop: flap -> explore -> defeat boss', (tester) async {
      await tester.pumpWidget(const MyApp());
      await tester.pumpAndSettle();
