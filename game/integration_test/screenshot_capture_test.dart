...
void main() {
  ...
  group('Screenshot Capture', () {
    testWidgets('Capture all store screens', (WidgetTester tester) async {
      ...
      await binding.takeScreenshot('MG-0008/01_main_menu');
      ...
      if (tester.any(startButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0008/02_game_play_initial');
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0008/03_game_play_progressed');
      ...
      if (tester.any(roadmapButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0008/04_level_roadmap');
      ...
      if (tester.any(dailyButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0008/05_daily_quests');
      ...
      if (tester.any(tournamentButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0008/06_tournament');
      ...
      if (tester.any(eventButton)) {
        ...
        await binding.convertFlutterSurfaceToImage();
        await binding.takeScreenshot('MG-0008/07_seasonal_event');
